	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2 text-center">
				<p class="lead">Skontaktuj sie z nami</p>
				<p><b>moto.cieslik@gmail.com</b><br><br></p>
				<ul class="list-inline list-social">
					<li><a href="https://github.com/andrewcieslik" class="btn btn-link"><i class="fa fa-github fa-fw"></i> Github</a></li>
					<li><a href="https://www.linkedin.com/in/andrewcieslik/" class="btn btn-link"><i class="fa fa-linkedin fa-fw"></i> LinkedIn</a></li>
				</ul>
			</div>
		</div>
